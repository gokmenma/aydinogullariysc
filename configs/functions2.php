 <?php
	...
	function ParaBirimleri($name, $val)
	{
		echo '<select required name=' . $name . ' class="selectpicker" data-style="btn-outline-secondary">
		<option ' . ($val == "TL" ? 'selected' : '') . ' selected="" value="TL">TL</option>
		<option ' . ($val == "Dolar" ? 'selected' : '') . ' value="Dolar">Dolar</option>
		<option ' . ($val == "Euro" ? 'selected' : '') . ' value="Euro">Euro</option>
		</select>';
	}
	...
	function KdvOranları($name, $val)
{
	...
	// 				<option ' . ($val == "Kg" ? 'selected' : '') . ' value="Kg">Kg</option>
	// 				<option ' . ($val == "Adet" ? 'selected' : '') . ' value="Adet">Adet</option>
	// 				<option ' . ($val == "Gram" ? 'selected' : '') . ' value="Gram">Gram</option>
	// 				<option ' . ($val == "Metre" ? 'selected' : '') . ' value="Metre">Metre</option>
	// 				<option ' . ($val == "Litre" ? 'selected' : '') . 'value="Litre">Litre</option>
	// 				<option ' . ($val == "m2" ? 'selected' : '') . ' value="m2">m2</option>

	// 			</select>';
	// }

	//units tablosundan statu = 1 olanları selecte aktar
