<!-- Geniş & Kullanıcı Dostu Toplu Ürün Ekleme Modalı (Merkezi Bileşen) -->
    ...
    <div class="modal-dialog modal-dialog-centered multi-product-dialog" role="document">
        <div class="modal-content quick-modal-content">
            ...
            <div class="modal-header quick-modal-header">
                <div class="d-flex align-items-center" style="gap: 14px;">
                    ...
                    <div>
                        ...
                        <p class="quick-modal-subtitle">Katalogdan birden fazla ürün ve miktar seçip tek seferde listeye aktarabilirsiniz.</p>
                    </div>
                </div>
            ...
            <div class="modal-footer quick-modal-footer">
                ...
                <button type="button" id="btnAddSelectedProductsToOffer" class="btn btn-quick-submit btn-add-selected-products" disabled>
                    <i class="fa fa-plus-circle"></i> <span>Seçilenleri Listeye Aktar (0)</span>
                </button>
            </div>
...
/* Satır İçi Ürün Otomatik Tamamlama (Inline Autocomplete) Dropdown */
