-- Migration: 20260924_092000_fix_view_offers_collation.sql
-- Düzeltme: view_offers görünümündeki 'durum' sütununun karakter seti ve karşılaştırma kuralını (collation) utf8mb4_unicode_ci olarak sabitleme
...
SELECT 
    ...
    CASE 
        WHEN `o`.`statu` = 1 THEN _utf8mb4'Bekliyor' COLLATE utf8mb4_unicode_ci
        WHEN `o`.`statu` = 2 THEN _utf8mb4'Tamamlandı' COLLATE utf8mb4_unicode_ci
        WHEN `o`.`statu` = 3 THEN _utf8mb4'Kabul Edilmedi' COLLATE utf8mb4_unicode_ci
        ELSE _utf8mb4'Diğer' COLLATE utf8mb4_unicode_ci
    END AS `durum` 
FROM `offers` `o` 
