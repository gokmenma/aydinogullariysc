...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result['success']) {
        echo "<script>window.location.href='index.php?p=permission-settings&st=newsuccess';</script>";
        exit;
    } else {
...
$selectedAuthCount = 0;
$initialCoverageRate = 0;

try {
    $logger = \getLogger("Pozisyon & Yetkiler");
    $logger->info("Yeni pozisyon tanımlama sayfası açıldı.", [
...
<div class="perm-new-container">
    <form action="" id="permNewForm" method="post">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap" style="gap: 12px;">
            <div class="page-title-box">
                ...
                <div class="page-title-text">
                    <h4>Yeni Pozisyon & Yetki Tanımlama</h4>
            ...
            <div class="d-flex align-items-center flex-wrap" style="gap: 8px;">
                ...
                <button type="button" class="btn btn-action-primary" id="btnSaveTop">
                    <i class="fa fa-save"></i> <span>Pozisyonu Oluştur</span>
                </button>
            </div>
        </div>
        ...
        <div class="form-card animate-fade-in">
            <div class="form-card-title">
                <div class="d-flex align-items-center" style="gap: 8px;">
                    ...
                    <span>Yeni Pozisyon Tanımı</span>
                    <span class="role-stat-chip">Yeni Kayıt</span>
                </div>
            </div>
        ...
        <div class="perm-toolbar-card animate-fade-in">
            ...
            <div class="filter-tabs">
                ...
                <button type="button" class="filter-tab-btn" data-filter="ungranted">
                    Seçilmeyenler (<span id="countUngrantedFilter"><?php echo $totalAuthCount; ?></span>)
                </button>
            </div>
            ...
            <div class="live-progress-container">
                <div class="live-progress-bar">
                    <div class="live-progress-fill" id="liveProgressBar" style="width: 0%;"></div>
                </div>
                ...
                <div class="perm-group-card">
                    ...
                    <div class="perm-group-body">
                        <?php foreach ($authList as $auth):
                            ...
                            $inputCheckId = "chk_auth_new_" . $groupId . "_" . $authId;
                        ?>
                        <label class="perm-item-box"
        ...
        <div class="sticky-save-bar animate-fade-in" id="stickySaveBar">
            <div class="sticky-text">
                ...
                <span class="d-none d-md-inline">Yeni Pozisyon</span>
                <span class="sticky-badge" id="stickySelectedCount">
                    0 / <?php echo $totalAuthCount; ?> İzin Seçili
                </span>
            </div>
...
$(document).ready(function () {
    ...
    function submitPermissionForm() {
        ...
        var formData = $("#permNewForm").serialize();
            ...
            success: function (res) {
                if (res.status === "success") {
                    Swal.fire({
                        icon: "success",
                        title: "Başarılı!",
                        text: res.message || "Yeni pozisyon başarıyla oluşturuldu.",
                        timer: 1500,
                        showConfirmButton: false
                    }).then(function () {
                        window.location.href = "index.php?p=permission-settings&st=newsuccess";
                    });
                } else {
                    Swal.fire({
                        icon: "error",
    ...
    $("#permNewForm").on("submit", function (e) {
        e.preventDefault();
        submitPermissionForm();
    });
