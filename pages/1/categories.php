...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	...
	?>
	<form method="POST" action="index.php?p=categories&mode=new&code=38&cc=087s3">
	<div class="clearfix mb-20">
		<div class="pull-left">
			<h5 class="text-blue">Ana Ürün Listesi </h5>				
		</div>	
  ...
  <tbody> <br>
    	...
    	$sfetch = $ac->prepare("SELECT COUNT(*) FROM products WHERE UrunGrubu = ?");
    	...
    	<tr title="<?php echo $ccs["sdesc"]; ?>">
			...
			<td><?php echo $ss; ?></td>
          	<td>
      			&nbsp;&nbsp; <a href="#" onClick="deleteRecord('<?php echo $ccs["stitle"]; ?> isimli ürün/hizmeti sistemden kaldırmak istediğinize emin misiniz?',<?php echo $ccs["id"]; ?>,'categories')"><span class="badge badge-danger">Sil</span></a>
			</td>
    </tr>
<?php 
$kx = $kx+1;
