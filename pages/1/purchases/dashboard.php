        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-12 mb-3 mb-lg-0">
                <div class="d-flex align-items-center mb-2" style="gap: 8px;">
                    ...
                    <span class="badge badge-primary px-3 py-2 font-12 font-weight-bold" style="border-radius: 8px; background: rgba(59, 130, 246, 0.35); border: 1px solid rgba(255,255,255,0.2);">
            ...
            <div class="col-lg-5 col-md-12 text-lg-right">
                <div class="d-flex flex-wrap justify-content-lg-end" style="gap: 8px;">
                    <?php if (permtrue('purchaseadd')) : ?>
                        <a href="index.php?p=purchases/manage" class="btn btn-success px-3 py-2 font-weight-bold shadow-sm" style="border-radius: 8px;">
                            <i class="fa fa-plus mr-1"></i> Yeni Sipariş
                        </a>
                    <?php endif; ?>
                    <?php if (permtrue('purchase-demand-add')) : ?>
                        <a href="index.php?p=purchase-demand-new" class="btn btn-primary px-3 py-2 font-weight-bold shadow-sm" style="border-radius: 8px;">
                            <i class="fa fa-file-text-o mr-1"></i> Satın Alma Talebi
                        </a>
                    <?php endif; ?>
                    <a href="index.php?p=purchases/price-request-list" class="btn btn-outline-light px-3 py-2 font-weight-bold" style="border-radius: 8px;">
                        <i class="fa fa-tags mr-1"></i> Fiyat Talepleri
                    </a>
                    <a href="index.php?p=purchases" class="btn btn-outline-light px-3 py-2 font-weight-bold" style="border-radius: 8px;">
