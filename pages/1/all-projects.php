							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $of["preg_date"];?></td>
									 ...
									 if(permtrue("pdelete")){
									  ?>
      	&nbsp;&nbsp; <a onClick="return confirm('Projeyi tamamen kaldırmak istediğinize emin misiniz?')"href="index.php?p=all-projects&type=delete&pid=<?php echo $of["id"];?>&codes=mdac4343"><span class="badge badge-danger">Sil</span></a></td>
										<?php } ?>
								</tr>
								<?php
								}
