...
<div class="alert alert-success" role="alert">
	...
	<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Müşteriye Ait Ödeme Listesi</h5>
...
<table class="data-table stripe hover">
  ...
  <tbody>
  	 <br><br>
    	<?php
    		$cq = $ac->prepare("SELECT * FROM payments ORDER BY id ASC ");
    		$cq->execute();
    		$kx = 1;
      ...
      <td><?php echo $as["okey"] == 1 ? "<s>" : ""; ?><?php echo dtf(TODAY,$as["lastdate"]);?> <?php echo $as["okey"] == 1 ? "</s>" : ""; ?></td>
      <td>&nbsp;&nbsp; 
		<?php
			if($as["okey"] == 0){
				if(permtrue("payadd")){
