<?php
	...
	if($pids && @$_GET["md"] == "update" && @$_GET["tt"]){
		...
		header("Location: index.php?p=yearly-payments&st=newsuccess");
	}
	...
	if(@$_GET["mode"] == "delete" && @$_GET["tid"]){
		...
		if($sil){
			header("Location:index.php?p=yearly-payments&type=delete");
		}
	}
...
<div class="alert alert-success" role="alert">
	...
	<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Yıllık Ödeme Listesi</h5>
...
<table class="data-table stripe hover">
  ...
  <tbody>
      ...
      <td>&nbsp;&nbsp; 
		...
		?>
     <a onClick="return confirm('Ödemeyi silmek istediğinize emin misiniz?')" href="index.php?p=yearly-payments&mode=delete&tid=<?php echo $as["id"];?>&tt=1"><span class="badge badge-danger">ÖDEMEYİ SİL</span></a> </td>
