...
if ($_POST) {
    ...
    if ($upquery) {
        header("Location: index.php?p=product-edit&id=" . $pid . "&st=success");
        ...
        <div class="form-group">
            <div class="row float-right m-2">
                ...
                <button id="submitButton" onclick="validateForm()" data-tooltip="Kaydet" data-tooltip-location="bottom"
                    ...
                    Kaydet</button>
                <a class="btn btn-secondary btn-sm ml-1 text-white" href="index.php?p=products"
    ...
    <form action="" method="POST" id="myForm">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-4">
                <?php OlcuBirimleri('Birimi', $result['Birimi']) ?>
            </div>
