...
<div class="alert alert-success" role="alert">
	...
	<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Teklif Birimleri</h5>
							
						</div>
						
					</div><form method="POST" action="index.php?p=units&mode=new&code=38&cc=087s3">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12">
			...
			<div class="form-group"> 
				<label><font color="red">(*)</font>Yeni Birim Adı:</label>
...
<table class="data-table stripe hover"><br>
  ...
  <tbody> <br><br>
    	<?php
    		$cq = $ac->prepare("SELECT * FROM units ORDER by id DESC");
    		$cq->execute();
    		$kx = 1;
      ...
      <td>
      	...
      	&nbsp;&nbsp; <a onClick="return confirm('Silmek istediğinize emin misiniz?')" href="index.php?p=units&mode=delete&code=04md177&md=active&xid=<?php echo $as["id"];?>"><span class="badge badge-danger">Sil</span></a></td>
