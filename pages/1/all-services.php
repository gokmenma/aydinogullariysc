		...
		<tbody>
			...
			?>
				<tr>
					...
					<td>
						<?php
						if (permtrue("servedit")) { ?><a href="index.php?p=edit-service&reg=true&md=update&pid=<?php echo $as["ID"]; ?>"><span class="badge badge-info">Düzenle</span></a>
						<?php } ?>
						&nbsp;&nbsp;

						<!-- <?php if (permtrue("servdelete")) { ?><a onClick="return confirm('<?php echo $as["Adi"]; ?> isimli ürün/hizmeti sistemden kaldırmak istediğinize emin misiniz?')" href="index.php?p=products&mode=delete&code=04md177&reg=true&md=active&pid=<?php echo $as["id"]; ?>"><span class="badge badge-danger">Sil</span></a><?php } ?></td> -->
