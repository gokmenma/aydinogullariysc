...
?>
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30"> <form method="POST" action="index.php?p=units&mode=new&code=38&cc=087s3">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12">
			...
			<div class="form-group"> 
				<label><font color="red">(*)</font>Birim Adı:</label>
