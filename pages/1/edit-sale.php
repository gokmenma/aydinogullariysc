...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-30 font-14">Sayfadaki <font color="red">(*)</font> yıldız ile belirtilen alanları boş bırakmayın..<br>Not: Satışlarınız, gelir-gider sayfasına otomatik olarak yansımaktadır. <br><font color="red">Tarih kısımlarını "gg-aa-yyyy" formatına uygun şekilde girmeye özen göstermelisiniz.</font><br>Ödemeler, başlangıç tarihinin günü esas alınarak aylık veya yıllık olarak, hizmet bitiş tarihine kadar tekrarlanır.</p>
						</div>
