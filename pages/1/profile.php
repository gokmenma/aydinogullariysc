					...
					<div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 bg-white border-radius-4 box-shadow">
							<div class="profile-photo">
								<a href="modal" data-toggle="modal" data-target="#modal" class="edit-avatar"><i class="fa fa-pencil"></i></a><?php
								if(sesset("avatar_link")){
									?>
									<img src="<?php echo sesset("avatar_link"); ?>" alt="" class="avatar-photo" />
								<?php }else{ 
									?>
							...
							<h5 class="text-center"><?php echo sesset("name")." ".sesset("surname");?></h5>
							<p class="text-center text-muted"><?php echo permd();?></p>
							<div class="profile-info">
								<h5 class="mb-20 weight-500">İletişim Bilgileriniz</h5>
								<ul>
									<li>
										<span>E-Posta Adresi:</span>
										<?php echo sesset("email");?>
									</li>
									<li>
									...
									<li>
										<span>Şehir:</span>
										<?php echo sesset("city");?>
									</li>
									<li>
										<span>Adres:</span>
										<?php echo sesset("address");?>
									</li>
								</ul>
							</div>
							<div class="profile-social">
								<h5 class="mb-20 weight-500">Sosyal Ağ</h5>
								<ul class="clearfix">
									<?php 
									if(sesset("facebook")){
									?>
									<li><a href="<?php echo sesset("facebook"); ?>" class="btn" data-bgcolor="#3b5998" data-color="#ffffff"><i class="fa fa-facebook"></i></a></li>
									<?php 
										}
									?>
<?php 
									if(sesset("twitter")){
									?>
									<li><a href="<?php echo sesset("twitter"); ?>" class="btn" data-bgcolor="#1da1f2" data-color="#ffffff"><i class="fa fa-twitter"></i></a></li>
									<?php 
										}
									?>
<?php 
									if(sesset("instagram")){
									?>
									<li><a href="<?php echo sesset("instagram"); ?>" class="btn" data-bgcolor="#f46f30" data-color="#ffffff"><i class="fa fa-instagram"></i></a></li>
									<?php 
										}
									?>
<?php 
									if(sesset("linkedin")){
									?>
									<li><a href="<?php echo sesset("linkedin"); ?>" class="btn" data-bgcolor="#007bb5" data-color="#ffffff"><i class="fa fa-linkedin"></i></a></li>
									<?php 
										}
									?>
<?php 
									if(sesset("skype")){
									?>
									<li><a href="<?php echo sesset("skype"); ?>" class="btn" data-bgcolor="#00aff0" data-color="#ffffff"><i class="fa fa-skype"></i></a></li>
									<?php 
										}
									?>
<?php 

	$ky = $ac->prepare("SELECT * FROM uskills WHERE uid = ?");
	$ky->execute(array(sesset("id")));
...
?>
							...
							<div class="profile-skills">
								<h5 class="mb-20 weight-500">Temel Beceriler</h5>
								<?php
								while($kk = $ky->fetch(PDO::FETCH_ASSOC)){
								?>
								<h6 class="mb-5"><?php echo $kk["stitle"]?></h6>
								<div class="progress mb-20" style="height: 6px;">
									<div class="progress-bar" role="progressbar" style="width: <?php echo $kk["spercent"]."%"; ?>" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
								<?php
									}
								?>
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Akış</a>
										</li>
										<li class="nav-item">
												...
												<form>
													<ul class="profile-edit-list row">
														<li class="weight-500 col-md-6">
															<h4 class="text-blue mb-20">Kişisel Bilgileri Düzenle</h4>
															...
															<div class="form-group">
																...
																<div class="custom-control custom-radio mb-5 mr-20">
																	...
																	<label class="custom-control-label weight-400" for="customRadio4">Erkek</label>
																</div>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="customRadio5" name="customRadio" class="custom-control-input">
																	<label class="custom-control-label weight-400" for="customRadio5">Kadın</label>
																</div>
																</div>
															</div>
															<div class="form-group">
