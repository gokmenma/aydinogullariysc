		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-30 font-14">Proje oluşturmadan önce projenin teklifini hazır etmeniz gerekir. <b>Yalnızca onaylanan teklifler</b> için proje oluşturabilirsiniz.<br>Hazırladığınız <b>teklif numarasını not almayı</b>, bu sayfada kullanmanız gerektiğini unutmayın.</p>
						</div>
				...
				<div class="html-editor pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<textarea name="pnotes" class="textarea_editor form-control border-radius-0" placeholder="Çalışmaya yeni başlanıldı..."></textarea><div class="form-group"><br>
						...
						<div class="form-group">
							<input type="submit" value="Projeyi Oluştur"class="form-control btn-outline-primary">
						</div>
					</form>
