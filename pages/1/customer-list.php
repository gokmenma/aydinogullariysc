...
<div class="alert alert-success" role="alert">
	...
	<div class="clearfix mb-20">
					...
					</div><?php if(permtrue("cadd")){?>
    <a href="index.php?p=new-customer&cc=0014s1"><button style="float:right;" type="button" class="btn btn-success">Yeni Müşteri</button></a><br>  <br><br><?php } ?>
