...
try {
    ...
    $logger->info("Cihaz dolum listesi görüntülendi.", [
...
<script>
    (function() {
        try {
            if (localStorage.getItem('aydinogullari_kpi_filling_collapsed') === 'true') {
                document.documentElement.classList.add('kpi-filling-collapsed-early');
            }
        } catch(e) {}
    })();
</script>
...
<style>
    /* Premium Dolum Listesi Sayfa Stilleri (reports.php ile tam uyumlu) */
    .filling-list-wrapper {
        width: 100%;
    }
    ...
    .kpi-filling-collapsed-early #kpiSummarySection {
        display: none !important;
    }
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="filling-list-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap px-1" style="gap: 12px;">
            <div class="page-title-box">
                ...
                <div class="page-title-text">
                    <h4>Cihaz Dolum Listesi</h4>
                    <p>Dolum tarihi gelmiş veya yaklaşan yangın söndürme cihazlarının takibi</p>
                </div>
            </div>
            <div class="d-flex align-items-center flex-wrap" style="gap: 8px;">
                ...
                <a href="index.php?p=reports/control-list" class="btn btn-outline-info btn-action-outline" title="Kontrol Listesi">
                    <i class="fa fa-calendar-check-o"></i> <span class="d-none d-sm-inline">Kontrol Listesi</span>
                </a>
                ...
                <button type="button" id="filling_list-toxls-top" class="btn btn-success btn-action-outline" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none; color: #fff;" title="Excel'e Aktar">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-3 mb-xl-0 px-1">
                <div class="crm-kpi-card">
                    <div class="crm-kpi-header">
                        <div>
                            <span class="crm-kpi-label">Dolum Zamanı Gelen</span>
                    ...
                    <div class="crm-kpi-footer">
                        <span class="text-muted font-11">Listelenen Cihaz</span>
            ...
            <div class="form-card-header">
                <div class="header-left-inner">
                    ...
                    <div>
                        ...
                        <p>İncelemek istediğiniz dolum periyoduna ait ay ve yılı belirleyin</p>
                    </div>
                </div>
            </div>
            <div class="form-card-body">
                <form method="POST" action="index.php?p=reports/filling-list" id="fillingFilterForm">
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-5 col-sm-12 mb-3 mb-md-0">
                            <label class="font-weight-600 font-12 text-muted mb-1 d-block"><i class="fa fa-calendar-o mr-1"></i> Dolum Ayı</label>
                            <?= Date::getMonthSelect('control_month', $month) ?>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3 mb-md-0">
                            <label class="font-weight-600 font-12 text-muted mb-1 d-block"><i class="fa fa-calendar mr-1"></i> Dolum Yılı</label>
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-12">
                            <div class="d-flex align-items-center flex-wrap" style="gap: 8px;">
                                ...
                                <a href="index.php?p=reports/filling-list" class="btn btn-outline-secondary btn-action-outline" title="Bu Ay / Filtreyi Sıfırla">
                                    <i class="fa fa-undo"></i>
                                </a>
                                <button type="button" id="filling_list-toxls" class="btn btn-outline-success btn-action-outline" title="Excel'e Aktar">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="header-left-inner">
                    ...
                    <div>
                        <h5>Dolum Tarihi Gelen Cihazlar</h5>
                        <p><?= htmlspecialchars($selectedMonthName . ' ' . $selectedYearName, ENT_QUOTES, 'UTF-8') ?> döneminde dolumu yapılacak yangın söndürme tüpleri listesi</p>
                    </div>
                </div>
            ...
            <div class="responsive">
                <table id="fillingTable" class="data-table table-hover table-bordered text-nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="w-10 text-nowrap text-center">ID</th>
                            <th>Firma Adı</th>
                            <th class="w-10 text-nowrap text-center">Rapor No</th>
                            <th class="text-center text-nowrap" style="width: 90px;">Cihaz No</th>
                    ...
                    <tbody>
                        ...
                        foreach ($controlList as $list) : 
                            ...
                            $cihazNo = htmlspecialchars($list->cihaz_no ?? '-', ENT_QUOTES, 'UTF-8');
                            $bolge = htmlspecialchars($list->bulundugu_bolge ?? '-', ENT_QUOTES, 'UTF-8');
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $cihazNo ?></td>
                                <td><?= $bolge ?></td>
...
$(document).ready(function () {
    // DataTable Başlatma
    if ($("#fillingTable").length) {
        var fTable = $("#fillingTable").DataTable({
            autoWidth: false,
            responsive: true,
            pageLength: 25,
            lengthMenu: [
            ...
            initComplete: function () {
                ...
                var $searchBox = $('#fillingTable_filter');
    ...
    $('html').removeClass('kpi-filling-collapsed-early');
    var isKpiCollapsed = localStorage.getItem('aydinogullari_kpi_filling_collapsed') === 'true';
    if (isKpiCollapsed) {
    ...
    $(document).on('click', '#toggleKpiSummary', function(){
        ...
        if (willCollapse) {
            ...
            localStorage.setItem('aydinogullari_kpi_filling_collapsed', 'true');
        } else {
            $kpi.removeClass('is-collapsed');
            $(this).find('i').removeClass('fa-chevron-down').addClass('fa-chevron-up');
            $(this).attr('title', 'Özet Kartlarını Gizle');
            localStorage.setItem('aydinogullari_kpi_filling_collapsed', 'false');
        }
    });

    // Excel Dışa Aktarma
    $(document).on('click', '#filling_list-toxls, #filling_list-toxls-top', function() {
        var month = $('#control_month').val() || '';
        var year = $('#control_year').val() || '';
        var url = 'pages/1/reports/ysc/filling-list-export-toxls.php?month=' + encodeURIComponent(month) + '&year=' + encodeURIComponent(year);
