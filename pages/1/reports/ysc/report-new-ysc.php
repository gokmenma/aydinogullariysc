...
if ($_POST) {
    ...
    if (empty($_POST["customer_id"]) && $cihazSayisi < 1) {
        header("Location: index.php?p=reports/ysc/report-new-ysc&type=1&st=empties");
        exit;
    }

    $report_type = $_POST["report_type"] ?? 1;
    $report_number = $_POST["reportnumber"] ?? $new_report_number;
    ...
    try {
        $insq = $ac->prepare("INSERT INTO reports SET 
            report_type = ?,
            report_number = ?,
            isemrino = ?,
            control_date = ?,
        ...
        error_log("YSC Raporu Ekleme Hatası: " . $e->getMessage());
        header("Location: index.php?p=reports/ysc/report-new-ysc&type=1&st=error");
        exit;
    }
}
...
if (@$_GET["st"] == "newsuccess") {
    showAlert("success", "Yangın Söndürme Tüpü Kontrol Raporu başarı ile kaydedildi!", "&type=1");
}
if (@$_GET["st"] == "error") {
            ...
            <div class="header-content">
                <div class="header-left">
                    ...
                    <div class="header-title">
                        <h4><?php echo htmlspecialchars($pdat["p_title"] ?? 'Yangın Söndürme Tüpü Kontrol Raporu', ENT_QUOTES, 'UTF-8'); ?></h4>
        ...
        <div class="form-card mb-4 animate-fade-in">
            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    ...
                    <input required name="reportnumber" id="reportnumber" type="text" value="<?php echo htmlspecialchars($new_report_number, ENT_QUOTES, 'UTF-8'); ?>" class="form-control font-weight-bold" placeholder="Rapor numarası">
                </div>
                ...
                <div class="form-field">
                    ...
                    <select name="isemrino" id="isemrino" data-size="10" class="form-control selectpicker" data-style="bg-white border">
                        ...
                        ?>
                            <option value="<?php echo htmlspecialchars($snValue, ENT_QUOTES, 'UTF-8'); ?>">
                ...
                <div class="form-field">
                    ...
                    <input required type="text" name="control_date" id="control_date" autocomplete="off" class="form-control date-picker" placeholder="Tarih seçiniz">
                </div>

                <div class="form-field">
                    <label for="validity_date"><font color="red">(*)</font> Geçerlilik Tarihi:</label>
                    <input required type="text" name="validity_date" id="validity_date" autocomplete="off" class="form-control date-picker" placeholder="Tarih seçiniz">
                </div>

                <!-- Kontrol Periyodu -->
                <div class="form-field">
                    <label for="control_period">Kontrol Periyodu:</label>
                    <input type="text" autocomplete="off" name="control_period" id="control_period" class="form-control" placeholder="Örn: 1 Yıl / 6 Ay">
                </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-field full-width">
                    ...
                    <div class="html-editor">
                        <textarea name="standarts" id="standarts" class="textarea_editor form-control" style="height: 120px; resize: vertical;" placeholder="İlgili Standartları yazınız"></textarea>
                    </div>
                </div>
                ...
                <div class="form-field full-width">
                    ...
                    <textarea name="equipment" id="equipment" class="form-control" style="height: 90px; resize: vertical;" placeholder="Kullanılan cihaz ve ekipmanları yazınız"></textarea>
                </div>
                ...
                <div class="form-field full-width">
                    ...
                    <div class="html-editor">
                        <textarea name="warnings" id="warnings" class="textarea_editor form-control" style="height: 120px; resize: vertical;" placeholder="İkaz ve uyarıları yazınız"></textarea>
                    </div>
                </div>
