...
<form method="POST" action="">
  ...
  <div class="row">
    <div class="col-md-6 col-sm-12">
      <div class="form-group"> 
        <label><font color="red">(*)</font>Müşteri Adı</label>
    ...
    <div class="col-sm-12 col-md-12"><label><font color="red">(*)</font>Hizmet Adı</label>
  ...
  <div class="col-md-6 col-sm-12">
      <div class="form-group"> 
        <label><font color="red">(*)</font>Fiyat</label>
    ...
    <div class="col-sm-12 col-md-12"><label><font color="red">(*)</font>Sonraki Ödeme Tarihi</label>
      ...
      ?>
                  ...
                  <label><font color="red">(*)</font>Hatırlatma Bildirimi Gönderim Tarihi</label>
